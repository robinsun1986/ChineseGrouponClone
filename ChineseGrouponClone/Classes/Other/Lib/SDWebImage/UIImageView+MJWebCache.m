...
- (void)setImageURLStr:(NSString *)urlStr placeholder:(UIImage *)placeholder dealedBlock:(MJWebImageDealedBlock)dealedBlock
{
    [self setImageWithURL:[NSURL URLWithString:urlStr] placeholderImage:placeholder options:SDWebImageRetryFailed | SDWebImageLowPriority progress:nil completed:nil dealedBlock:dealedBlock];
}
@end
